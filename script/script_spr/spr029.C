{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_spr/spr029.root");
    ...
    // T->Draw("((a[2]-1200)*(a[3]-1285))^(1/2)>>h0(200,100,600)");

    //陽電子一個のイベントのみでADC分布を確認
    // T->Draw("a[4]-1309>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460");

    // T->Draw("a[5]-1375>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460");

    // T->Draw("a[6]-1079>>h0(100,-15,500)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460");

    // T->Draw("a[7]-1262>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460");

    //陽電子一個のイベントかつペデスタルの標準誤差3倍以下を排除でADC分布を確認
    // T->Draw("a[4]-1309>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[4]-1309>6.12");

    // T->Draw("a[5]-1375>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[5]-1375>3.21");

    // T->Draw("a[6]-1079>>h0(100,-15,500)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[6]-1079>8.52");

    T->Draw("a[7]-1262>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[7]-1262>4.71");

    //合計
    // T->Draw("a[4]-1309+a[5]-1375+a[6]-1079+a[7]-1262>>h0(100,-30,700)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460");
    ...
    // T->Draw("((a[2]-1200)*(a[3]-1285))^(1/2)>>h1(200,100,600)","((a[2]-1200)*(a[3]-1285))^(1/2)>460","same hist");

    //ペデスタルを表示
    // T->Draw("a[4]-1309>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[4]-1309<=6.12","same hist");

    // T->Draw("a[5]-1375>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[5]-1375<=3.21","same hist");

    // T->Draw("a[6]-1079>>h1(100,-15,500)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[6]-1079<=8.52","same hist");

    T->Draw("a[7]-1262>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<460&&a[7]-1262<=4.71","same hist");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    ...
    // c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/output_spr/spr029_a[7]_separated.png");
}
...
void fitGaussians3(TH1F* hist, Double_t rangeMin, Double_t rangeMax) {
    ...
    fitFunc->FixParameter(4, 55.69);
    fitFunc->FixParameter(7, 55.69 * 2);
    fitFunc->FixParameter(10, 55.69 * 3);

    // Sigmaを固定
    fitFunc->FixParameter(5, 26.60);
    fitFunc->FixParameter(8, 26.60);
    fitFunc->FixParameter(11, 26.60);
