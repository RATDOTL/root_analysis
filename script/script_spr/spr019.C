{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_spr/spr019.root");
    ...
    // T->Draw("a[4]-1309>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[4]-1309>6.12");

    // T->Draw("a[5]-1375>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[5]-1375>3.21");

    // T->Draw("a[6]-1079>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[6]-1079>8.52");

    // T->Draw("a[7]-1262>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[7]-1262>4.71");

    //合計
    // T->Draw("a[4]-1309+a[5]-1375+a[6]-1079+a[7]-1262>>h0(100,-15,700)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415");
    ...
    T->Draw("((a[2]-1200)*(a[3]-1285))^(1/2)>>h1(200,100,500)","((a[2]-1200)*(a[3]-1285))^(1/2)>390","same hist");

    //ペデスタルを表示
    // T->Draw("a[4]-1309>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[4]-1309<=6.12","same hist");

    // T->Draw("a[5]-1375>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[5]-1375<=3.21","same hist");

    // T->Draw("a[6]-1079>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[6]-1079<=8.52","same hist");

    // T->Draw("a[7]-1262>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<415&&a[7]-1262<=4.71","same hist");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    ...
    c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/output_spr/spr019_a[2]a[3]detail.png");
}
