{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_spr/spr023.root");
    ...
    // T->Draw("a[6]-1079>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390");

    // T->Draw("a[7]-1262>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390");

    //陽電子一個のイベントかつペデスタルの標準誤差3倍以下を排除でADC分布を確認
    // T->Draw("a[4]-1309>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[4]-1309>6.12");

    // T->Draw("a[5]-1375>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[5]-1375>3.21");

    // T->Draw("a[6]-1079>>h0(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[6]-1079>8.52");
    ...
    T->Draw("((a[2]-1200)*(a[3]-1285))^(1/2)>>h1(200,100,500)","((a[2]-1200)*(a[3]-1285))^(1/2)>420","same hist");

    //ペデスタルを表示
    // T->Draw("a[4]-1309>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[4]-1309<=6.12","same hist");

    // T->Draw("a[5]-1375>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[5]-1375<=3.21","same hist");

    // T->Draw("a[6]-1079>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[6]-1079<=8.52","same hist");

    // T->Draw("a[7]-1262>>h1(100,-15,400)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<390&&a[7]-1262<=4.71","same hist");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    ...
    // c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/output_spr/spr023_a[2]a[3]detail.png");
}
