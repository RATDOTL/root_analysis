{
    ...
    // T->Draw("a[6]-1079>>h0(100,-15,500)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<420");
    ...
    // T->Draw("a[6]-1079>>h0(100,-15,500)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<420&&a[6]-1079>8.52");
    ...
    // T->Draw("a[6]-1079>>h1(100,-15,500)","150<=((a[2]-1200)*(a[3]-1285))^(1/2)&&((a[2]-1200)*(a[3]-1285))^(1/2)<420&&a[6]-1079<=8.52","same hist");
