{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_don/don172.root");
...
void fitGaussians3(TH1F* hist, Double_t rangeMin, Double_t rangeMax) {
    ...
    fitFunc->FixParameter(4, 62.79);
    fitFunc->FixParameter(7, 62.79 * 2);
    fitFunc->FixParameter(10, 62.79 * 3);

    // Sigmaを固定
    fitFunc->FixParameter(5, 28.71);
    fitFunc->FixParameter(8, 28.71);
    fitFunc->FixParameter(11, 28.71);
