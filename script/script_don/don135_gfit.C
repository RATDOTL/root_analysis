{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_don/don135.root");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    ...
    // c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/output_don/don135-gfit(fixedMean-Sigma)_a[0]_E.png");
}
...
void fitGaussians3(TH1F* hist, Double_t rangeMin, Double_t rangeMax) {
    ...
    fitFunc->SetParameter(3, hist->GetBinContent(hist->FindBin(52)));  // Amplitude 2
    fitFunc->SetParameter(4, 65);  // Mean 2
    fitFunc->SetParameter(5, 25.0);  // Sigma 2

    fitFunc->SetParameter(6, hist->GetBinContent(hist->FindBin(104)));  // Amplitude 3
    fitFunc->SetParameter(7, 65*2);  // Mean 3
    fitFunc->SetParameter(8, 25.0);  // Sigma 3

    fitFunc->SetParameter(9, hist->GetBinContent(hist->FindBin(156)));  // Amplitude 4
    fitFunc->SetParameter(10, 65*3);  // Mean 4
    fitFunc->SetParameter(11, 25.0);  // Sigma 4

    fitFunc->SetParameter(12, hist->GetBinContent(hist->FindBin(156)));  // Amplitude 5
    fitFunc->SetParameter(13, 65*4);  // Mean 5
    fitFunc->SetParameter(14, 25.0);  // Sigma 5

    fitFunc->SetParameter(15, hist->GetBinContent(hist->FindBin(156)));  // Amplitude 6
    fitFunc->SetParameter(16, 65*5);  // Mean 6
    fitFunc->SetParameter(17, 25.0);  // Sigma 6

    // Meanを固定
    fitFunc->FixParameter(1, 0);
    fitFunc->FixParameter(4, 65.14);
    fitFunc->FixParameter(7, 65.14 * 2);
    fitFunc->FixParameter(10, 65.14 * 3);
    fitFunc->FixParameter(13, 65.14 * 4);
    fitFunc->FixParameter(16, 65.14 * 5);

    // Sigmaを固定
    fitFunc->FixParameter(5, 26.32);
    fitFunc->FixParameter(8, 26.32);
    fitFunc->FixParameter(11, 26.32);
    fitFunc->FixParameter(14, 26.32);
    fitFunc->FixParameter(17, 26.32);
