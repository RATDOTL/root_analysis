{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_don/don024.root");
    ...
    // T->Draw("a[0]-1257>>h4(300,0,400)","","same histogram");
    // // // // // T->Draw("a[0]>>h1(100,0,3000)","","same");
    ...
    // T->Draw("a[5]-1380>>h5(300,0,400)","","same histogram");
    // // // // // T->Draw("a[0]>>h1(100,0,3000)","","same");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    // c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/output_don/don024(red)_a[0].png");
