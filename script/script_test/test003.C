{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data/data_test/test003.root");
    ...
    // T->Draw("a[3]>>h0(100,1200,1500)","1000<t[3]&&t[3]<2000");
    ...
    // T->Draw("a[3]>>h1(100,1200,1500)","!(1000<t[3]&&t[3]<2000)","same");
