{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data_win/win010.root");
    ...
    // T->Draw("a[1]>>h0(100,1300,1500)","200<t[1]&&t[1]<600");
    // T->Draw("a[1]>>h0(100,1350,1450)","t[1]>600");
    ...
    // T->Draw("a[0]>>h1(100,1250,1500)","200<t[0]&&t[0]<500","same");
    // T->Draw("a[0]>>h1(100,1250,1500)","t[0]>500","same");

    // T->Draw("a[1]>>h1(100,1350,1450)","250<a[3]&&a[3]<450","same");
    // T->Draw("a[1]>>h1(100,1300,1500)","t[1]>600","same");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    // c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/win010_t[1].png");
// }