{
    ...
    // data_hal
    TFile *f0 = TFile :: Open("C:/Users/posei/Desktop/tokken/winscp/data_test/data_hal/hal006.root");
    TFile *f1 = TFile :: Open("C:/Users/posei/Desktop/tokken/winscp/data_test/data_hal/hal007.root");
    

    f0->cd();
    // T->Draw("a[0]>>h0(100,0,3000)");

    T->Draw("a[0]>>h0(100,1300,2000)","510<t[0]&&t[0]<600");
    ...
    T->Draw("a[0]>>h1(100,1000,1500)","!(510<t[0]&&t[0]<600)","same");
