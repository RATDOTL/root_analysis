{
    ...
    // labo PC
    TFile *f0 = TFile :: Open("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/data_test/test004.root");
    ...
    f0->cd();
    // T->Draw("t[0]>>h0(100,1000,1600)");
    T->Draw("t[0]");
    // T->Draw("a[1]>>h0(100,1300,1500)");
    // T->Draw("a[2]>>h0(100,1400,1650)");
    // T->Draw("a[3]>>h0(100,1300,1600)");

    
    // T->Draw("a[2]>>h0(100,1500,1700)","600<t[0]&&t[0]<1600");
    // T->Draw("a[2]>>h0(100,1400,1600)","t[2]>1600");

    // T->Draw("a[3]>>h0(100,1250,1600)","!(1000<t[1]&&t[1]<1600)");
    ...
    // T->Draw("a[2]>>h1(100,1500,1700)","!(600<t[0]&&t[0]<1600)","same");
    // T->Draw("a[2]>>h1(100,1300,1700)","t[2]>1600","same");

    // T->Draw("a[3]>>h1(100,1250,1600)","1000<t[1]&&t[1]<1600","same");
    // T->Draw("a[3]>>h1(100,1250,1500)","t[2]>1600","same");
...
//     c1->Print("C:/Users/posei/Desktop/tokken/winscp/data_test/output/hal008_009_a[3].pdf");
    c1->Print("C:/Users/niiyama/Desktop/Kyotaro_Nishi/root/root_analysis/output/test004_t[0].png");
// }