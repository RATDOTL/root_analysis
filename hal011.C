{
    ...
    // data_hal
    TFile *f0 = TFile :: Open("C:/Users/posei/Desktop/tokken/winscp/data_test/data_hal/hal011.root");
    ...
    // T->Draw("a[0]>>h0(100,1100,2000)","500<t[0]&&t[0]<650");

    // T->Draw("a[1]>>h0(100,1000,2500)","300<t[1]&&t[1]<700");

    // T->Draw("a[4]>>h0(100,1000,2500)","300<t[2]&&t[2]<800");
